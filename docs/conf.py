# -*- coding: utf-8 -*-
#
# hp3parclient documentation build configuration file, created by
...
#htmlhelp_basename = 'hp3parclientdoc'

htmlhelp_basename = 'HP3PARClient' + release.replace('.', '_')
